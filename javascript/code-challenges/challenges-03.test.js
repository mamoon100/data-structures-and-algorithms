...
const containsAnd = (arr) => {
  let newArr = arr.filter((e) => e.includes("and"));
  return newArr;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  let newArr = arr.filter((e) => forbiddenValues.indexOf(e) === -1);
  return newArr;
};
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  let newArr = arr.filter((e) => e.baseStat > minBaseStat);
  return newArr;
};
...
const getStatName = (arr, minBaseStat) => {
  ...
  return newArr.map((e) => e.stat.name);
};
...
const getCharactersWithoutChildren = (arr) => {
  return arr.filter((e) => e.children === undefined);
};
...
const evenOddNumericValues = (arr) => {
  let newArr = arr.filter((e) => typeof e === "number");
  return newArr.map((e) => (e % 2 === 0 ? "even" : "odd"));
};
