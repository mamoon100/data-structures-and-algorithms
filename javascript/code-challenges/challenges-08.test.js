...
const sortByChildren = (charArray) =>
  charArray.sort((a, b) =>
    a.children && b.children
      ? a.children.length - b.children.length === 0
...
const isCapitalized = (str) => str.match(/[A-Z]\s*\w*/g) || [];

// str.match(/\w*[A-Z]\w/gi);
...
const citiesAtoJ = (arr) => arr.filter((item) => item.match(/^[A-J]\w*/));
